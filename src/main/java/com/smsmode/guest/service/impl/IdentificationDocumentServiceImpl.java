...
public class IdentificationDocumentServiceImpl implements IdentificationDocumentService {
    ...
    public ResponseEntity<IdDocumentGetResource> create(String guestId, IdDocumentPostResource idDocumentPostResource) {
        ...
        IdentityDocumentModel idDocumentModel = identificationDocumentMapper.postResourceToModel(idDocumentPostResource);
    ...
    public ResponseEntity<Page<IdDocumentGetResource>> retrieveAllByGuestId(String guestId, Pageable pageable) {
        ...
        Specification<IdentityDocumentModel> spec = IdentificationDocumentSpecification.withGuestId(guestId);
        Page<IdentityDocumentModel> idDocuments = identificationDocumentDaoService.findAllBy(spec, pageable);
    ...
    public ResponseEntity<IdDocumentGetResource> retrieveById(String guestId, String idDocumentId) {
        ...
        IdentityDocumentModel idDocument = identificationDocumentDaoService.findOneBy(spec);
    ...
    public ResponseEntity<IdDocumentGetResource> updateById(String guestId, String idDocumentId, IdDocumentPatchResource idDocumentPatchResource) {
        ...
        IdentityDocumentModel existingIdDocument = identificationDocumentDaoService.findOneBy(spec);
        IdentityDocumentModel updatedIdDocument = identificationDocumentMapper.patchResourceToModel(idDocumentPatchResource, existingIdDocument);
